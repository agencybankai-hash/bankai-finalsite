...
export const checklist: CheckPage[] = [
  {
    ...
    items: [
      ...
      { id: "home-cases", label: "Кейсы (3: 1kredit, Object First, SOS)", source: "cases.ts:homeCases", status: "done" },
      ...
      { id: "home-company", label: "Кто строит систему заявок (текст + статы)", source: "site.ts:companyBlock", status: "done" },
      ...
      { id: "home-audience", label: "«Кому подходит» (квалификатор)", source: "site.ts:homeAudience", status: "done" },
    ],
  },
  {
    route: "/services/seo",
  ...
  },
  {
    ...
    items: [
      ...
      { id: "caseslist-kz", label: "Кейсы в Казахстане (1kredit)", source: "cases.ts:kzCases", status: "done" },
      { id: "caseslist-intl", label: "Кейсы на зарубежных рынках (US/RU)", source: "cases.ts:intlCases", status: "data", todo: "ROCS/Unitel — каркасы, вписать реальные цифры" },
      { id: "caseslist-inprogress", label: "Сейчас в работе (Сбербанк, Самокат×РЭЙ, AI Moving)", source: "cases.ts:inProgressCases", status: "data", todo: "результаты обновить после запуска" },
      { id: "caseslist-templates", label: "Образцы подачи (11, помечены; +3 KZ перенесены)", source: "cases.ts:templateCases", status: "done" },
