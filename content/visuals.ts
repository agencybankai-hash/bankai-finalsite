...
export const visualCopy: Record<HeroVisualKind, Omit<VisualCopy, "float">> = {
  ...
  "seo-city": {
    ...
    meta: "карты + сайт",
    label:
      "Схема: карточка компании в картах со звонком и сайт, который поднимается в органической выдаче по запросам города",
    query: "ремонт квартир",
    kpis: [
      { value: "с 3-4 мес", label: "рост заявок из поиска" },
      { value: "6-12 мес", label: "стабильный поток" },
    ],
    disclaimer: SEO_DISCLAIMER,
  },
  "seo-regions": {
    ...
    meta: "один домен",
    label:
      "Схема: регионы по очереди на одном домене - Алматы в работе и приносит заявки, Астана следующая, Шымкент в очереди; KZ-версия по данным",
    kpis: [
      { value: "3-4 нед.", label: "на первый регион" },
      { value: "ежемесячно", label: "отчёт и следующий регион" },
    ],
    disclaimer: SEO_DISCLAIMER,
  },
  "seo-store": {
    ...
    meta: "фильтры",
    label:
      "Схема: категория магазина с фильтрами под спрос попадает в выдачу с ценой и наличием и получает заказы; сортировка и пагинация закрыты от индекса",
    query: "кроссовки для бега мужские",
    kpis: [
      { value: "с 3-4 мес", label: "рост заказов из поиска" },
      { value: "от 2 нед.", label: "техническая чистка" },
    ],
    disclaimer: SEO_DISCLAIMER,
  },
  context: {
  ...
  "context-city": {
    title: "Google Ads · кабинет",
    label: "Схема: объявление в Google по запросам города, клик и заявка с понятной ценой",
    query: "ремонт квартир",
    kpis: [
      { value: "3-5 дней", label: "до первых показов" },
      { value: "3-6 нед.", label: "стабильная цена заявки" },
  ...
  "google-ads": {
    title: "Google Ads · кабинет",
    meta: "неделя 1",
    label: "Схема: настроенная кампания Google Ads - объявление, клик и заявка",
    query: "ремонт квартир цена",
    kpis: [
  ...
  "yandex-direct": {
    title: "Яндекс Директ · кабинет",
    meta: "неделя 1",
    label: "Схема: объявление в Яндексе над выдачей, клик и обращение",
    query: "ремонт квартир цена",
    kpis: [
      { value: "3-5 дней", label: "до первых показов" },
