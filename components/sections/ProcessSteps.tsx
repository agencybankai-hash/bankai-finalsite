 ...
 * Движение (область InView вокруг сетки): отрезок вытягивается к соседнему
 * узлу за 0.35 с, после проявления шага - 0.4 + i × 0.15 с.
 */
          ...
          return (
            <div key={s.n} data-reveal className="relative">
              ...
              {linked && (
                <span
                  aria-hidden
                  className="a-grow-x pointer-events-none absolute -right-8 left-9 top-[18px] hidden h-px bg-border lg:block"
                  style={anim({ delay: 0.4, i, step: 0.15, dur: 0.35 })}
                />
              )}
